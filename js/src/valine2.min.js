!function(e, t) {
    ...
    , function(e, t, n) {
        ...
        function a(e, t) {
            ...
            for (var r = 0, i = [], o = !1, a = e.length, c = 0; c < a; c++) {
                ...
                if (!1 !== o || "=" !== g)
                    if (!1 === o || c !== r || '"' !== g && "'" !== g || "=" !== e.charAt(c - 1))
                        ...
                        if (-1 === (f = e.indexOf(g, c + 1)))
                            break;
                        h = p.trim(e.slice(r + 1, f)),
                        n(o, h),
                        o = !1,
                        c = f,
                        r = c + 1
            ...
            return r < e.length && (!1 === o ? n(e.slice(r)) : n(o, u(p.trim(e.slice(r))))),
            p.trim(i.join(" "))
        }
        function s(e, t) {
            for (; t < e.length; t++) {
    ...
    , function(e, t, n) {
        ...
        !function(i) {
            ...
            function d(e, t) {
                e[t >> 5] |= 128 << t % 32,
                e[14 + (t + 64 >>> 9 << 4)] = t;
                var n, r, i, a, s, d = 1732584193, h = -271733879, f = -1732584194, g = 271733878;
                for (n = 0; n < e.length; n += 16)
                    r = d,
                    i = h,
                    a = f,
                    s = g,
                    d = l(d, h, f, g, e[n], 7, -680876936),
                    g = l(g, d, h, f, e[n + 1], 12, -389564586),
                    f = l(f, g, d, h, e[n + 2], 17, 606105819),
                    h = l(h, f, g, d, e[n + 3], 22, -1044525330),
                    d = l(d, h, f, g, e[n + 4], 7, -176418897),
                    g = l(g, d, h, f, e[n + 5], 12, 1200080426),
                    f = l(f, g, d, h, e[n + 6], 17, -1473231341),
                    h = l(h, f, g, d, e[n + 7], 22, -45705983),
                    d = l(d, h, f, g, e[n + 8], 7, 1770035416),
                    g = l(g, d, h, f, e[n + 9], 12, -1958414417),
                    f = l(f, g, d, h, e[n + 10], 17, -42063),
                    h = l(h, f, g, d, e[n + 11], 22, -1990404162),
                    d = l(d, h, f, g, e[n + 12], 7, 1804603682),
                    g = l(g, d, h, f, e[n + 13], 12, -40341101),
                    f = l(f, g, d, h, e[n + 14], 17, -1502002290),
                    h = l(h, f, g, d, e[n + 15], 22, 1236535329),
                    d = c(d, h, f, g, e[n + 1], 5, -165796510),
                    g = c(g, d, h, f, e[n + 6], 9, -1069501632),
                    f = c(f, g, d, h, e[n + 11], 14, 643717713),
                    h = c(h, f, g, d, e[n], 20, -373897302),
                    d = c(d, h, f, g, e[n + 5], 5, -701558691),
                    g = c(g, d, h, f, e[n + 10], 9, 38016083),
                    f = c(f, g, d, h, e[n + 15], 14, -660478335),
                    h = c(h, f, g, d, e[n + 4], 20, -405537848),
                    d = c(d, h, f, g, e[n + 9], 5, 568446438),
                    g = c(g, d, h, f, e[n + 14], 9, -1019803690),
                    f = c(f, g, d, h, e[n + 3], 14, -187363961),
                    h = c(h, f, g, d, e[n + 8], 20, 1163531501),
                    d = c(d, h, f, g, e[n + 13], 5, -1444681467),
                    g = c(g, d, h, f, e[n + 2], 9, -51403784),
                    f = c(f, g, d, h, e[n + 7], 14, 1735328473),
                    h = c(h, f, g, d, e[n + 12], 20, -1926607734),
                    d = u(d, h, f, g, e[n + 5], 4, -378558),
                    g = u(g, d, h, f, e[n + 8], 11, -2022574463),
                    f = u(f, g, d, h, e[n + 11], 16, 1839030562),
                    h = u(h, f, g, d, e[n + 14], 23, -35309556),
                    d = u(d, h, f, g, e[n + 1], 4, -1530992060),
                    g = u(g, d, h, f, e[n + 4], 11, 1272893353),
                    f = u(f, g, d, h, e[n + 7], 16, -155497632),
                    h = u(h, f, g, d, e[n + 10], 23, -1094730640),
                    d = u(d, h, f, g, e[n + 13], 4, 681279174),
                    g = u(g, d, h, f, e[n], 11, -358537222),
                    f = u(f, g, d, h, e[n + 3], 16, -722521979),
                    h = u(h, f, g, d, e[n + 6], 23, 76029189),
                    d = u(d, h, f, g, e[n + 9], 4, -640364487),
                    g = u(g, d, h, f, e[n + 12], 11, -421815835),
                    f = u(f, g, d, h, e[n + 15], 16, 530742520),
                    h = u(h, f, g, d, e[n + 2], 23, -995338651),
                    d = p(d, h, f, g, e[n], 6, -198630844),
                    g = p(g, d, h, f, e[n + 7], 10, 1126891415),
                    f = p(f, g, d, h, e[n + 14], 15, -1416354905),
                    h = p(h, f, g, d, e[n + 5], 21, -57434055),
                    d = p(d, h, f, g, e[n + 12], 6, 1700485571),
                    g = p(g, d, h, f, e[n + 3], 10, -1894986606),
                    f = p(f, g, d, h, e[n + 10], 15, -1051523),
                    h = p(h, f, g, d, e[n + 1], 21, -2054922799),
                    d = p(d, h, f, g, e[n + 8], 6, 1873313359),
                    g = p(g, d, h, f, e[n + 15], 10, -30611744),
                    f = p(f, g, d, h, e[n + 6], 15, -1560198380),
                    h = p(h, f, g, d, e[n + 13], 21, 1309151649),
                    d = p(d, h, f, g, e[n + 4], 6, -145523070),
                    g = p(g, d, h, f, e[n + 11], 10, -1120210379),
                    f = p(f, g, d, h, e[n + 2], 15, 718787259),
                    h = p(h, f, g, d, e[n + 9], 21, -343485551),
                    d = o(d, r),
                    h = o(h, i),
                    f = o(f, a),
                    g = o(g, s);
            ...
            function m(e, t) {
                ...
                n = 0; n < 16; n += 1)
                    o[n] = 909522486 ^ i[n],
                    a[n] = 1549556828 ^ i[n];
                return r = d(o.concat(f(t)), 512 + 8 * t.length),
                h(d(a.concat(r), 640))
            }
            function v(e) {
        ...
        (function(t) {
            !function(t) {
                ...
                function n(e) {
                    ...
                    this.rules = y.normal,
                    this.options.pedantic ? this.rules = y.pedantic : this.options.gfm && (this.options.tables ? this.rules = y.tables : this.rules = y.gfm)
                }
                function r(e, t) {
                    if (this.options = t || b.defaults,
                    this.links = e,
                    this.rules = x.normal,
                    ...
                    this.options.pedantic ? this.rules = x.pedantic : this.options.gfm && (this.options.breaks ? this.rules = x.breaks : this.rules = x.gfm)
                }
                function i(e) {
                    this.options = e || b.defaults
                }
                ...
                function l(e, t) {
                    if (t) {
                        if (l.escapeTest.test(e))
                            return e.replace(l.escapeReplace, function(e) {
                                return l.replacements[e]
                            })
                    } else if (l.escapeTestNoEncode.test(e))
                        return e.replace(l.escapeReplaceNoEncode, function(e) {
                            return l.replacements[e]
                        });
                    return e
                }
                ...
                function d(e, t) {
                    return w[" " + e] || (/^[^:]+:\/*[^\/]*$/.test(e) ? w[" " + e] = e + "/" : w[" " + e] = m(e, "/", !0)),
                    e = w[" " + e],
                ...
                y.paragraph = u(y.paragraph).replace("hr", y.hr).replace("heading", y.heading).replace("lheading", y.lheading).replace("tag", y._tag).getRegex(),
                ...
                y.gfm.paragraph = u(y.paragraph).replace("(?!", "(?!" + y.gfm.fences.source.replace("\\1", "\\2") + "|" + y.list.source.replace("\\1", "\\3") + "|").getRegex(),
                y.tables = f({}, y.gfm, {
                    nptable: /^ *([^|\n ].*\|.*)\n *([-:]+ *\|[-| :]*)(?:\n((?:.*[^>\n ].*(?:\n|$))*)\n*|$)/,
                    table: /^ *\|(.+)\n *\|?( *[-:]+[-| :]*)(?:\n((?: *[^>\n ].*(?:\n|$))*)\n*|$)/
                }),
                ...
                n.prototype.token = function(e, t) {
                    ...
                    for (var n, r, i, o, a, s, l, c, u, p, d, h, f, v, b, x; e; )
                        ...
                        s.header.length === s.align.length)) {
                            ...
                            d = 0; d < s.align.length; d++)
                                /^ *-+: *$/.test(s.align[d]) ? s.align[d] = "right" : /^ *:-+: *$/.test(s.align[d]) ? s.align[d] = "center" : /^ *:-+ *$/.test(s.align[d]) ? s.align[d] = "left" : s.align[d] = null;
                            ...
                            d = 0; d < f; d++)
                                ...
                                s = s.replace(/^ *([*+-]|\d+\.) */, ""),
                                ~s.indexOf("\n ") && (p -= s.length,
                                s = this.options.pedantic ? s.replace(/^ {1,4}/gm, "") : s.replace(new RegExp("^ {1," + p + "}","gm"), "")),
                                d !== f - 1 && (a = y.bullet.exec(i[d + 1])[0],
                                (o.length > 1 ? 1 === a.length : a.length > 1 || this.options.smartLists && a !== o) && (e = i.slice(d + 1).join("\n") + e,
                                d = f - 1)),
                                r = n || /\n\n(?!\s*$)/.test(s),
                                d !== f - 1 && (n = "\n" === s.charAt(s.length - 1),
                                r || (r = n)),
                        ...
                        s.header.length === s.align.length)) {
                            ...
                            d = 0; d < s.align.length; d++)
                                /^ *-+: *$/.test(s.align[d]) ? s.align[d] = "right" : /^ *:-+: *$/.test(s.align[d]) ? s.align[d] = "center" : /^ *:-+ *$/.test(s.align[d]) ? s.align[d] = "left" : s.align[d] = null;
                            for (d = 0; d < s.cells.length; d++)
                                s.cells[d] = g(s.cells[d].replace(/^ *\| *| *\| *$/g, ""), s.header.length);
                            this.tokens.push(s)
                ...
                x._punctuation = "!\"#$%&'()*+,\\-./:;<=>?@\\[^_{|}~",
                x.em = u(x.em).replace(/punctuation/g, x._punctuation).getRegex(),
                x._escapes = /\\([!"#$%&'()*+,\-.\/:;<=>?@\[\]\\^_`{|}~])/g,
                x._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/,
                x._email = /[a-zA-Z0-9.!#$%&'*+\/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/,
                x.autolink = u(x.autolink).replace("scheme", x._scheme).replace("email", x._email).getRegex(),
                x._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/,
                x.tag = u(x.tag).replace("comment", y._comment).replace("attribute", x._attribute).getRegex(),
                x._label = /(?:\[[^\[\]]*\]|\\[\[\]]?|`[^`]*`|[^\[\]\\])*?/,
                x._href = /\s*(<(?:\\[<>]?|[^\s<>\\])*>|[^\s\x00-\x1f]*)/,
                x._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/,
                x.link = u(x.link).replace("label", x._label).replace("href", x._href).replace("title", x._title).getRegex(),
                x.reflink = u(x.reflink).replace("label", x._label).getRegex(),
                x.normal = f({}, x),
                ...
                x.gfm = f({}, x.normal, {
                    ...
                    del: /^~+(?=\S)([\s\S]*?\S)~+/,
                    text: u(x.text).replace("]|", "~]|").replace("|$", "|https?://|ftp://|www\\.|[a-zA-Z0-9.!#$%&'*+/=?^_`{\\|}~-]+@|$").getRegex()
                }),
                x.gfm.url = u(x.gfm.url, "i").replace("email", x.gfm._extended_email).getRegex(),
                x.breaks = f({}, x.gfm, {
                ...
                r.prototype.output = function(e) {
                    for (var t, n, i, o, a, s, c = ""; e; )
                        if (a = this.rules.escape.exec(e))
                            ...
                            if (u > -1) {
                                var p = a[2].length - u;
                                a[2] = a[2].substring(0, u),
                                a[0] = a[0].substring(0, a[0].length - p)
                            }
                            e = e.substring(a[0].length),
                            this.inLink = !0,
                            i = a[2],
                            ...
                            e = e.substring(a[0].length),
                            c += this.renderer.codespan(l(a[2].trim(), !0));
                ...
                i.prototype.link = function(e, t, n) {
                    if (null === (e = p(this.options.sanitize, this.options.baseUrl, e)))
                        return n;
                    var r = '<a href="' + l(e) + '"';
                    return t && (r += ' title="' + t + '"'),
                    r += ">" + n + "</a>"
                ...
                a.prototype.parse = function(e) {
                    ...
                    this.inlineText = new r(e.links,f({}, this.options, {
                        renderer: new o
                    })),
            ...
            function r(e) {
                return function(t) {
                    ...
                    return t.replace(/([{}])\1|[{](.*?)(?:!(.+?))?[}]/g, function(t, a, s, l) {
                        ...
                        if (c.length > 0) {
                            if ("IMPLICIT" === o)
                                throw n("cannot switch from implicit to explicit numbering");
                            o = "EXPLICIT"
                        } else {
                            if ("EXPLICIT" === o)
                                throw n("cannot switch from explicit to implicit numbering");
                            o = "IMPLICIT",
                            c = String(i),
                            i += 1
                        }
            ...
            return i(e, [{
                ...
                value: function(e) {
                    ...
                    try {
                        ...
                        for (var y in b) {
                            ...
                            x.id = "no-view";
                            x.setAttribute("src", e.emoticon_url + "/" + b[y]),
                            m.appendChild(x)
                        }
                        p || (n.init({
                        ...
                        var w = "https://github.com/DesertsP/Valine/issues";
                        return void (t.el ? t.nodata.show('<pre style="color:red;text-align:left;">' + e + "<br>Valine:<b>" + t.version + "</b><br>feedback：" + w + "</pre>") : console && console.log("%c" + e + "\n%cValine%c" + t.version + " " + w, "color:red;", "background:#000;padding:5px;line-height:30px;color:#fff;", "background:#456;line-height:30px;padding:5px;color:#fff;"))
                    }
                    var k = '<div class="spinner"><div class="r1"></div><div class="r2"></div><div class="r3"></div><div class="r4"></div><div class="r5"></div></div>'
                    ...
                    t.loading = {
                        ...
                        hide: function() {
                            ...
                            0 === t.el.querySelectorAll(".vcard").length && t.nodata.show()
                        }
                    };
                    ...
                    t.alert = {
                        show: function(e) {
                            _.innerHTML = '<div class="valert txt-center"><div class="vtext">' + e.text + '</div><div class="vbtns"></div></div>';
                            ...
                            if (n.innerHTML = "" + r + (e.type && i),
                            _.querySelector(".vcancel").addEventListener("click", function(e) {
                                t.alert.hide()
                            }),
                    ...
                    T.notEqualTo("isSpam", !0),
                    T.count().then(function(n) {
                        t.el.querySelector(".count").innerHTML = "" + n,
                        t.bind(e)
                    }, function(e) {
                        console.log(e)
                    })
                ...
                value: function(e) {
                        ...
                        if (void 0 !== r) {
                            ...
                            if (document.selection)
                                ...
                                var o = n.selectionStart
                                  , a = n.selectionEnd
                                  , s = a;
                                n.value = n.value.substring(0, o) + i + n.value.substring(a, n.value.length),
                                s += i.length,
                                n.focus(),
                                n.selectionStart = s,
                                n.selectionEnd = s
                    ...
                    v.on("click", r, function(e) {
                        ...
                        t.el.querySelector(".auth-section").removeAttribute("style"),
                    ...
                    var i = function(e) {
                      ...
                      , p = function e() {
                        ...
                        t.loading.show(),
                        t.v.Query.doCloudQuery("select nick, comment, link, rid, emailHash, isSpam\n                                                   from Comment\n                                                   where (rid='' or rid is not exists) and (url='" + u.url + "' or url='" + u.url + "/')\n                                                   order by -createdAt\n                                                   limit " + (n - 1) * h + "," + h).then(function(r) {
                            r = r && r.results || [];
                            var i = r.length;
                            if (i) {
                                for (var o = 0; o < i; o++)
                                    if (!r[o].get("isSpam")) {
                                        ...
                                        a.setAttribute("style", "margin-bottom: .5em"),
                                        f(a)
                                    }
                    ...
                    t.v.Query.doCloudQuery("select count(*)\n                                    from Comment\n                                    where (rid='' or rid is not exists) \n                                           and (url='" + u.url + "' or url='" + u.url + "/')\n                                    order by -createdAt").then(function(e) {
                        c = e.count,
                        p(1)
                    });
                    var f = function e(n) {
                        var r = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 1
                          ...
                          , a = n.getAttribute("id");
                        if (r <= 0 && i.setAttribute("style", "margin-left: 0 !important"),
                        r >= d)
                            return void t.v.Query.doCloudQuery("select count(*)\n                               from Comment\n                               where rid='" + a + "' and (url='" + u.url + "' or url='" + u.url + "/')\n                               order by -createdAt").then(function(r) {
                                if (r.count > 0) {
                                    var o = i.querySelector(".vshow-children-wrapper");
                                    o.setAttribute("style", "display: block !important;"),
                                    o.innerHTML = '<span class="vshow-children" rid="' + a + '">' + t.i18n.more + "</span>";
                      ...
                      , m = function(e) {
                        ...
                        for (var l = n || t.el.querySelector(".vlist"), c = l.querySelectorAll("li"), u = o.querySelectorAll("a"), p = 0, d = u.length; p < d; p++) {
                            var h = u[p];
                      ...
                      , w = {};
                    for (var k in x)
                        x.hasOwnProperty(k) && function() {
                            var e = x[k]
                              , n = t.el.querySelector("." + k);
                            w[e] = n,
                            v.on("input", n, function(t) {
                                u[e] = n.value
                            })
                        }();
                    var A = function() {
                        ...
                        if (e) {
                            ...
                            for (var r in n) {
                                var i = n[r];
                                t.el.querySelector(".v" + i).value = e[i],
                                u[i] = e[i]
                            }
                            if ("" != e.mail) {
                                t.el.querySelector(".visitor_avatar").setAttribute("src", "https://gravatar.loli.net/avatar/" + s(e.mail.toLowerCase().trim()) + "?size=80&d=https%3a%2f%2fgravatar.loli.net%2favatar%2f9e63c80900d106cbbec5a9f4ea433a3e.jpg%3fsize%3d80")
                            }
                        }
                    };
                    A(),
                    t.reset = function() {
                        ...
                        u.nick = "",
                        A(),
                        C.getAttribute("triggered") && (C.setAttribute("style", "display:none;"),
                        C.removeAttribute("triggered")),
                        L.getAttribute("triggered") && (L.setAttribute("style", "display:none;"),
                        L.removeAttribute("triggered")),
                        t.el.querySelector(".vcancel-comment-reply").setAttribute("style", "display:none"),
                        t.el.querySelector("#vinputs-placeholder").appendChild(t.el.querySelector(".vinputs-wrap"))
                    }
                    ;
                    var S = t.el.querySelector(".vsubmit")
                      , _ = function(n) {
                        ...
                        if ("" == u.comment)
                            return void w.comment.focus();
                        if ("" == u.nick)
                            return void w.nick.focus();
                        if (u.comment = a(o(u.comment.replace(/!\(:(.*?\.\w+):\)/g, '<img src="' + e.emoticon_url + '/$1" alt="$1" class="vemoticon-img">')), {
                            onIgnoreTagAttr: function(e, t, n, r) {
                                if ("class" === t)
                                    return t + '="' + a.escapeAttrValue(n) + '"'
                            }
                        }),
                    ...
                    v.on("click", z, function(e) {
                        ...
                        L.removeAttribute("triggered")),
                        C.getAttribute("triggered") ? (C.setAttribute("style", "display:none;"),
                        C.removeAttribute("triggered")) : (C.removeAttribute("style"),
                        C.setAttribute("triggered", 1))
                    });
                    var T = t.el.querySelector(".vpreview-btn")
                      , L = t.el.querySelector(".vpreview-text");
                    v.on("click", T, function(t) {
                        if (C.getAttribute("triggered") && (C.setAttribute("style", "display:none;"),
                        C.removeAttribute("triggered")),
                        L.getAttribute("triggered"))
                            L.setAttribute("style", "display:none;"),
                            L.removeAttribute("triggered");
                        else {
                            if ("" == u.comment)
                                return void w.comment.focus();
                            L.innerHTML = a(o(u.comment.replace(/!\(:(.*?\.\w+):\)/g, '<img src="' + e.emoticon_url + '/$1" alt="$1" class="vemoticon-img">')), {
                                onIgnoreTagAttr: function(e, t, n, r) {
                                    if ("class" === t)
                                        return t + '="' + a.escapeAttrValue(n) + '"'
                                }
                    ...
                    var q = function() {
                      ...
                      , I = function() {
                        ...
                        n.set("emailHash", s(u.mail.toLowerCase().trim())),
                        n.setACL(q()),
                        n.save().then(function(e) {
                            ...
                            if (n.innerText = Number(n.innerText) + 1,
                            "" === u.rid)
                                m(e, null, !0);
                            else {
                      ...
                      , $ = function(e) {
                        ...
                        v.on("click", r, function(i) {
                            ...
                            u.rid = a,
                            u.at = o,
                            w.comment.value = o + " ，" + w.comment.value,
                            e.querySelector("#comment-" + n).appendChild(t.el.querySelector(".vinputs-wrap")),
                            t.el.querySelector(".vcancel-comment-reply").removeAttribute("style"),
                            t.el.querySelector(".comment_trigger").setAttribute("style", "display:none"),
                            t.el.querySelector(".auth-section").removeAttribute("style"),
                            t.el.querySelector(".veditor").focus(),
                            w.comment.focus()
                        })
    ...
    , function(e, t, n) {
        ...
        o.prototype.process = function(e) {
            ...
            return s(e, function(e, t, n, s, c) {
                var u = i[n]
                  , p = !1;
                if (!0 === u ? p = u : "function" == typeof u ? p = u(s) : u instanceof RegExp && (p = u.test(s)),
                !0 !== p && (p = !1),
                s = l(n, s)) {
                    var d = {
                        position: t,
    ...
    , function(e, t, n) {
        ...
        function h(e, t, n) {
            ...
            (t.convertToAbsoluteUrls || o) && (r = x(r)),
